		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "﻿Using ODATA and Routing through Master-Detail Application",
									"targetURL": "#UsingODATAandRoutingthroughMasterDetailApplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"UsingODATAandRoutingthroughMasterDetailApplication-display": {
								"semanticObject": "UsingODATAandRoutingthroughMasterDetailApplication",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sfc.routing",
									"url": sap.ui.require.toUrl("com/sfc/routing")
								}
							}
						}
					}
